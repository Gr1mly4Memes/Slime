Slime includes patches and features from other projects, and without these projects, 
Slime wouldn't exist today. 
Here is the list of projects that Slime takes code and patches from:
