...
public class SlimeModsChestHorse extends CraftChestedHorse {

    public SlimeModsChestHorse(CraftServer server, AbstractChestedHorse entity) {
        super(server, entity);
    }

    @Override
    public String toString() {
        return "SlimeModsChestHorse{" + getType() + '}';
    }
