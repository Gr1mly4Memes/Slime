...
public class PlayerEventDispatcher {
    ...
    public void onContainerClose(PlayerContainerEvent.Close event) {
        // Slime start - Custom Container compatible with mods
        ...
        if (abstractcontainermenu.getBukkitView() == null) {
            org.bukkit.inventory.Inventory inventory = new CraftInventory(new SlimeModsInventory(abstractcontainermenu, event.getEntity()));
    ...
    public void onEnterSleepEvent(CanPlayerSleepEvent event) {
        ...
        var cbedResult = CraftEventFactory.callPlayerBedEnterEvent(serverPlayer, blockposition, nmsBedResult);
