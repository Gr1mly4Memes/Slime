...
public interface MenuType extends Keyed, io.papermc.paper.world.flag.FeatureDependant { // Paper - make FeatureDependant
     ...
     */
    Typed<InventoryView, LocationInventoryViewBuilder<InventoryView>> GENERIC_9X6 = get("generic_9x6");
    /**
     ...
     */
    Typed<InventoryView, InventoryViewBuilder<InventoryView>> typed();
     ...
     */
    <V extends InventoryView, B extends InventoryViewBuilder<V>> Typed<V, B> typed(final Class<V> viewClass) throws IllegalArgumentException;
