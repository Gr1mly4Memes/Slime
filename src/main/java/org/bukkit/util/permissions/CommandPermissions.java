...
public final class CommandPermissions {
    ...
    public static Permission registerPermissions(@NotNull Permission parent) {
        ...
        DefaultPermissions.registerPermission(PREFIX + "org/purpurmc/purpur", "Allows the user to use the purpur command", PermissionDefault.OP, commands); // Purpur - Default permissions
