...
public class SpigotConfig
{
    ...
    private static void attributeMaxes()
    {
        ...
        ( (net.minecraft.world.entity.ai.attributes.RangedAttribute) net.minecraft.world.entity.ai.attributes.Attributes.MAX_ABSORPTION.value() ).maxValue = maxAbsorption;
        maxHealth = getDouble( "settings.attribute.maxHealth.max", maxHealth );
        ( (net.minecraft.world.entity.ai.attributes.RangedAttribute) net.minecraft.world.entity.ai.attributes.Attributes.MAX_HEALTH.value() ).maxValue = maxHealth;
        // movementSpeed - NeoForge uses PercentageAttribute instead of RangedAttribute, skip for now
        movementSpeed = getDouble( "settings.attribute.movementSpeed.max", movementSpeed );
        attackDamage = getDouble( "settings.attribute.attackDamage.max", attackDamage );
        ( (net.minecraft.world.entity.ai.attributes.RangedAttribute) net.minecraft.world.entity.ai.attributes.Attributes.ATTACK_DAMAGE.value() ).maxValue = attackDamage;
    }
