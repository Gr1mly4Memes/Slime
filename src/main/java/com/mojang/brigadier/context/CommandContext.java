...
public class CommandContext<S>
{
    ...
    private final List<com.mojang.brigadier.context.ParsedCommandNode<S>> nodes;
    private final com.mojang.brigadier.context.StringRange range;
    private final CommandContext<S> child;
    private final RedirectModifier<S> modifier;
    private final boolean forks;
    
    public CommandContext(final S source, final String input, final Map<String, ParsedArgument<S, ?>> arguments, final Command<S> command, final CommandNode<S> rootNode, final List<com.mojang.brigadier.context.ParsedCommandNode<S>> nodes, final com.mojang.brigadier.context.StringRange range, final CommandContext<S> child, final RedirectModifier<S> modifier, final boolean forks) {
        this.source = source;
        this.input = input;
