...
public class SuggestionsBuilder
{
    ...
    private final List<com.mojang.brigadier.suggestion.Suggestion> result;
    
    public SuggestionsBuilder(final String input, final String inputLowerCase, final int start) {
        this.result = new ArrayList<com.mojang.brigadier.suggestion.Suggestion>();
        this.input = input;
    ...
    public SuggestionsBuilder suggest(final String text) {
        ...
        this.result.add(new com.mojang.brigadier.suggestion.Suggestion(StringRange.between(this.start, this.input.length()), text));
        return this;
    }
    ...
    public SuggestionsBuilder suggest(final int value) {
        this.result.add(new com.mojang.brigadier.suggestion.IntegerSuggestion(StringRange.between(this.start, this.input.length()), value));
        return this;
    }
